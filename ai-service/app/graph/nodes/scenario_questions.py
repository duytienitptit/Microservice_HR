...
from app.graph.prompts import SCENARIO_QUESTIONS_PROMPT
from app.graph.llm import get_llm
from app.graph.utils import build_messages, format_chat_history
from app.graph.rag_client import get_jd_context

async def scenario_questions_node(state: InterviewState) -> dict:
    """
    Scenario Questions Node: Asks candidate behavioral or situational questions
    matching the target role and JD expectations.
    """
    ...
    prompt = SCENARIO_QUESTIONS_PROMPT.format(
    ...
    is_new_stage = state.get("current_stage") != "SCENARIO_QUESTIONS"
